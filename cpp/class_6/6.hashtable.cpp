/*************************************************************************
	...
	> Author: ls
	> Mail: 
	> Created Time: Thu 11 Mar 2021 10:02:02 PM CST
 ************************************************************************/
...
int HashTable::capacity() { return __size; }
...
int main() {
    ...
    cout << h1.capacity() << endl;
    cout << h2.capacity() << endl;
    cout << h1["hello"] << " " << h1["world"] << " " << h1["haha"] << endl;
    while (cin >> op >> s) {
        switch (op) {
            case 0: {
            ...
            case 2: {
                cout << "find " << s << " to hash table 1 = ";
                cout << h1.find(s) << endl;
                cout << "find " << s << " to hash table 2 = ";
                cout << h2.find(s) << endl;
            } break;
        }
    }
